use std::ops::Index;
use crate::indexed_type::Unindexed;
...
impl<'a, Data, Indices> ParallelIterator for ParSelectIndicesIter<'a, Data, Indices, Unindexed>
where
...
impl<'a, Data, Indices> IndexedParallelIterator for ParSelectIndicesIter<'a, Data, Indices, Unindexed>
where
    Data: ?Sized + Index<Indices::Item> + Sync,
    Data::Output: 'a + Sync,
